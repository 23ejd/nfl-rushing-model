...
```{r}
suppressWarnings({ 
rf_model <- ranger(Rushing.Yards ~ . -Team - Rank - Player - School - Position -YPC - YPG, data = df, num.trees = 100, mtry = 5, importance = 'impurity')
...
```{r}
cor(df %>% select(Rushing.Attempts, First.Downs, Rushing.TDs, Games.Started, Fumbles, Games.Played, Rushing.Success.Rate, Longest.Rushing.Attempt, Age))
